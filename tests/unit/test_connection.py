...
def make_ws_connection(connection_string, password=None, debug_options=None,
                       error=None):
    ...
    def fake_wsapp(url, header=None, on_open=None, on_message=None,
    ...
    with patch('circremote.connection.websocket.WebSocketApp', side_effect=fake_wsapp), \
...
class TestCircuitPythonConnection:
    ...
    def test_init_websocket_connection_with_password(self):
        ...
        connection, captured = make_ws_connection('192.168.1.100:8080', password='secret')
    ...
    def test_connection_error_websocket(self, capsys):
        ...
        with pytest.raises(RuntimeError, match="Connection refused"):
            make_ws_connection('192.168.1.100:8080',
